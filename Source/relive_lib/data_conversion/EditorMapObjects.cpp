#include "EditorMapObjects.hpp"
#include "relive_tlvs_serialization.hpp"
#include <nlohmann/json.hpp>

std::map<ReliveTypes, MapObjectBase::FactoryFuncs>& MapObjectBase::GetEditorFactoryRegistry()
{
    static std::map<ReliveTypes, FactoryFuncs> registry;
    return registry;
}

// Each Editor_ type below registers itself in GetEditorFactoryRegistry() via registered_ during
// static init - defining the types is enough, nothing refers to them by name.
