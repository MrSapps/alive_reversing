...
static FmvInfo g_S1_Fmvs_4C8740[] = {
    knullptrFmvInfo,
    {"LOGOINT.DDV", 579u, 1, 1},
    {"XAOSOPEN.DDV", 45u, 1, 2},
    {"GTDDLOGO.DDV", 210u, 1, 1},
    {"PROPHECY.DDV", 890u, 1, 2}};
...
static FmvInfo g_R1_Fmvs_4C9A60[10] = {
    {"", 0u, 0, 0},
    {"BEGIN.DDV", 3310u, 1, 1},
    {"GAMEBGN.DDV", 300u, 1, 2},
    {"R1P18P19.DDV", 60u, 0, 2},
    {"R1P19P18.DDV", 60u, 0, 2},
    {"DEMOOPEN.DDV", 500u, 1, 1},
    {"R1P18P1.DDV", 320u, 0, 2},
    {"R1P1P18.DDV", 320u, 0, 2},
    {"BARRELS.DDV", 349u, 1, 1},
    {"", 0u, 0, 2}};
...
static FmvInfo g_L1_Fmvs_4C9730[28] = {
    ...
    {"$L1P6C6.DDV", 177u, 0, 2},
    {"E1P4C8.DDV", 45u, 0, 2},
    {"PARSCAR.DDV", 273u, 1, 1},
    {"SCRSCAR.DDV", 239u, 1, 1},
    {"$L1P1C3.DDV", 459u, 0, 2},
    {"$L1P1C4.DDV", 388u, 0, 2},
    {"$L1P1C9.DDV", 206u, 0, 2},
    {"L1P1P2.DDV", 60u, 0, 2},
    ...
    {"MOON.DDV", 1258u, 1, 1},
    {"L1P1C14.DDV", 45u, 0, 2},
    {"ABEMORPH.DDV", 248u, 1, 1},
    {"L1P5C4.DDV", 45u, 0, 2},
    {"PARAMITE.DDV", 244u, 1, 2},
    {"SCRAB.DDV", 244u, 1, 2},
    {"LP5C3C4.DDV", 45u, 0, 2},
    {"LP5C4C3.DDV", 45u, 0, 2},
    {"LP1C3C15.DDV", 45u, 0, 2},
    {"LP1C15C3.DDV", 45u, 0, 2},
    {"LP1C3C16.DDV", 45u, 0, 2},
    {"LP1C16C3.DDV", 45u, 0, 2},
    {"L1P6E2.DDV", 45u, 0, 2},
    {"", 0u, 0, 2}};
...
static FmvInfo g_D2_Fmvs_4C9270[53] = {
    ...
    {"D2P9P10.DDV", 45u, 0, 2},
    {"D2P10P9.DDV", 45u, 0, 2},
    {"D2P10P10.DDV", 45u, 0, 2},
    {"D2P10P10.DDV", 45u, 0, 2},
    {"D2P11P10.DDV", 45u, 0, 2},
    {"D2P10D7.DDV", 45u, 0, 2},
    {"D2P1P10B.DDV", 45u, 0, 2},
    {"D2P10P1B.DDV", 45u, 0, 2},
    {"D2P2P10B.DDV", 45u, 0, 2},
    {"D2P10P2B.DDV", 45u, 0, 2},
    {"D2P3P10B.DDV", 45u, 0, 2},
    {"D2P10P3B.DDV", 45u, 0, 2},
    {"D2P4P10B.DDV", 45u, 0, 2},
    {"D2P10P4B.DDV", 45u, 0, 2},
    {"D2P5P10B.DDV", 45u, 0, 2},
    {"D2P10P5B.DDV", 45u, 0, 2},
    {"D2P6P10B.DDV", 45u, 0, 2},
    {"D2P10P6B.DDV", 45u, 0, 2},
    {"D2P7P10B.DDV", 45u, 0, 2},
    {"D2P10P7B.DDV", 45u, 0, 2},
    {"D2P8P10B.DDV", 45u, 0, 2},
    {"D2P10P8B.DDV", 45u, 0, 2},
    {"D2P9P10B.DDV", 45u, 0, 2},
    {"D2P10P9B.DDV", 45u, 0, 2},
    {"D2P10P10B.DDV", 45u, 0, 2},
    {"D2P10P10B.DDV", 45u, 0, 2},
    {"D2P11P10B.DDV", 45u, 0, 2},
    {"D2P10P11B.DDV", 45u, 0, 2},
    {"D2P10D7.DDV", 45u, 0, 2},
    {"D7C11C12.DDV", 45u, 0, 2},
    {"D7C12C11.DDV", 45u, 0, 2},
    {"SCRAB.DDV", 244u, 1, 2},
    {"D1P9D2.DDV", 135u, 0, 2},
    {"ABEMORPH.DDV", 248u, 1, 1},
    {"L1P5C4.DDV", 45u, 0, 2},
...
static FmvInfo g_C1_Fmvs_4C87D0[5] = {
    {"", 0u, 0, 0},
    {"DRAG.DDV", 495u, 1, 1},
    {"GOODEND.DDV", 1218u, 1, 1},
    {"CREDITS.DDV", 1900u, 1, 1},
    {"", 0u, 0, 0}};

static FmvInfo g_R6_R2_Fmvs_4C9C70[21] = {
    {"", 0u, 0, 0},
    {"HALTS.DDV", 280u, 1, 1},
    {"MOLLOCK.DDV", 225u, 1, 1},
    {"DRAG.DDV", 495u, 1, 1},
    {"BADEND.DDV", 410u, 1, 1},
    {"R1P18P19.DDV", 60u, 0, 2},
    {"R1P19P18.DDV", 60u, 0, 2},
    {"$R2P19C3.DDV", 340u, 0, 2},
    {"R1P11P6.DDV", 45u, 0, 2},
    {"R1P6P11.DDV", 45u, 0, 2},
    {"R1P18P1.DDV", 320u, 1, 2},
    {"R1P1P18.DDV", 320u, 1, 2},
    {"R1P13P14.DDV", 310u, 1, 2},
    {"R1P14P13.DDV", 310u, 1, 2},
    {"R1P13P1.DDV", 310u, 1, 2},
    {"R1P1P13.DDV", 310u, 1, 2},
    {"GOODEND.DDV", 1218u, 1, 1},
    {"E2P2R2.DDV", 45u, 0, 2},
    {"HALTS.DDV", 280u, 1, 1},
    {"TVCOMM.DDV", 450u, 1, 1},
...
static FmvInfo g_F2_Fmvs_4C8A70[53] = {
    ...
    {"F1P9F2.DDV", 139u, 0, 2},
    {"F2P8F4.DDV", 45u, 0, 2},
    {"F4C11C13.DDV", 45u, 0, 2},
    {"F4C13C11.DDV", 45u, 0, 2},
    {"", 0u, 0, 2},
    {"", 0u, 0, 2},
    {"", 0u, 0, 2},
    {"", 0u, 0, 2},
...
std::vector<std::string> Path_GetAllFmvNames()
{
    return relive::CollectUniqueFmvNames({
        {g_S1_Fmvs_4C8740, ALIVE_COUNTOF(g_S1_Fmvs_4C8740)},
        {g_R1_Fmvs_4C9A60, ALIVE_COUNTOF(g_R1_Fmvs_4C9A60)},
        {g_L1_Fmvs_4C9730, ALIVE_COUNTOF(g_L1_Fmvs_4C9730)},
        {g_F1_Fmvs_4C88E0, ALIVE_COUNTOF(g_F1_Fmvs_4C88E0)},
        {g_E1_Fmvs_4C8F10, ALIVE_COUNTOF(g_E1_Fmvs_4C8F10)},
        {g_E2_Fmvs_4C8FE0, ALIVE_COUNTOF(g_E2_Fmvs_4C8FE0)},
        {g_D1_Fmvs_4C90E0, ALIVE_COUNTOF(g_D1_Fmvs_4C90E0)},
        {g_D2_Fmvs_4C9270, ALIVE_COUNTOF(g_D2_Fmvs_4C9270)},
        {g_C1_Fmvs_4C87D0, ALIVE_COUNTOF(g_C1_Fmvs_4C87D0)},
        {g_R6_R2_Fmvs_4C9C70, ALIVE_COUNTOF(g_R6_R2_Fmvs_4C9C70)},
        {g_F2_Fmvs_4C8A70, ALIVE_COUNTOF(g_F2_Fmvs_4C8A70)},
    });
}
