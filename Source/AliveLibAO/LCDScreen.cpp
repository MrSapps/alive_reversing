    ...
    : BaseGameObject(true, 0, resMan, map)
{
    ...
    mCharacterWidth = mFont.MeasureLeadingGlyphWidth(mMessageBuffer, mCharacterByteLength);
...
void LCDScreen::VUpdate()
{
    ...
    if (mOffsetX > mCharacterWidth)
    {
        ...
        gFontDrawScreenSpace = true;
        mCharacterWidth = mFont.MeasureLeadingGlyphWidth(mActiveMessage, mCharacterByteLength);
        gFontDrawScreenSpace = false;
    }
